...
font-size: 16px;"> Last access : <?php 
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a  class="active-menu" href="ecchart.php">EC Graph</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Graph - EC (Electrical Conductivity)</h2>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="ec-chart" id="ec-chart"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        var chart = new Chartist.Line('.ec-chart', {
            labels: timeData,
            series: [ecData]
        },
            {
