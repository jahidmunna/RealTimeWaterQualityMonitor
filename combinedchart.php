                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="combinedchart.php">Combined Graph</a>
                            </li>
                        </ul>
                    </li>
<li>
    ...
    <script>
        ...
        phData = phData.splice(phData.length - 15);
        timeData = timeData.splice(timeData.length - 15);
        dateData = dateData.splice(dateData.length - 15);
        turbidityData = turbidityData.splice(turbidityData.length - 15);
        tempData = tempData.splice(tempData.length - 15);
        ecData = ecData.splice(ecData.length - 15);

        /* will slice array to show only last 8 data in the graph*/
        // ecData = ecData.splice(ecData.length - 9);
        var chart = new Chartist.Line('.combined-chart', {
            labels: timeData,
             series: [phData,tempData,ecData,turbidityData]
        },
            {
                chartPadding: {
                    top: 10,
